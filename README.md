...
The user sends PKU_A signed to the asset. The latter checks the signature of the user and, if signature is correct, the asset uses PK<sub>U_A</sub> to calculate:
